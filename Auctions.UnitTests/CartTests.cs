...
namespace Auctions.UnitTests
{
    ...
    public class CartTests
    {
        ...
        public void Can_Add_New_Lines()
        {
            ...
            Lot p1 = new Lot { LotID = 1, Name = "P1" };
            Lot p2 = new Lot { LotID = 2, Name = "P2" };
        ...
        public void Can_Add_Quantity_For_Existing_Lines()
        {
            ...
            CartLine[] results = target.Lines.OrderBy(c => c.Lot.LotID).ToArray();
            // Assert
            Assert.AreEqual(results.Length, 2);
        ...
        public void Can_Remove_Line()
        {
            ...
            Lot p1 = new Lot { LotID = 1, Name = "P1" };
            Lot p2 = new Lot { LotID = 2, Name = "P2" };
            Lot p3 = new Lot { LotID = 3, Name = "P3" };
            // Arrange - create a new cart
            Cart target = new Cart();
            ...
            // Assert
            Assert.AreEqual(target.Lines.Where(c => c.Lot == p2).Count(), 0);
        ...
        {
            // Arrange - create some test lots
            Lot p1 = new Lot { LotID = 1, Name = "P1", CurrentPrice = 1 };
            Lot p2 = new Lot { LotID = 2, Name = "P2", CurrentPrice = 1 };
            // Arrange - create a new cart
            Cart target = new Cart();
            // Act
            target.AddItem(p1, 1);
        ...
        public void Can_Add_To_Cart()
        {
            ...
            Assert.AreEqual(cart.Lines.ToArray()[0].Lot.LotID, 1);
        }
        [TestMethod]
